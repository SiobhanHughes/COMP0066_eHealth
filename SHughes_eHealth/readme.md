...
1. Create sql database: createdb.py will create the eHealth database (all tables and default admin) in the directory you are currently in. Natvigate to /SHughes_eHealth/eHealth and run createdb.py to create the eHealth databse in this directory. Using config.py gives the file path required to access the eHealth.db database.
