...
def main():
    ...
    patient3 = ('Nicola', 'Guo', 'nhughes@gmail.com', 'Berkeley street', 'London', 'N1', '07878842306', dt.date.today(),
                'Charlie', 'Guo', 'cguo@gamil.com', 'Berkeley street', 'London', 'N1', '07869229113', 'husband')
    ...
    if conn is not None:
        ...
        patient1_record = ('NHS001', insert_patient1, dt.date(1984,12,14), 'penecillin', 'none', 'none', 'no', 3, 'gym classes three time a week')
        dbu.insert_patient_record(conn, patient1_record)
        
        insert_patient2 = dbu.insert_patient(conn, patient2)
        patient2_record = ('NHS002', insert_patient2, dt.date(1950,8,23), 'none', 'diabetes', 'none', 'no', 0, 'moderate activity level, mainly walking')
        dbu.insert_patient_record(conn, patient2_record)
        
        insert_patient3 = dbu.insert_patient(conn, patient3)
        patient3_record = ('NHS003', insert_patient3, dt.date(1984,12,14), 'penecillin', 'none', 'none', 'no', 3, 'gym classes three time a week')
